...
export function AddVehicle() {
  ...
  return (
    <div>
      <PageHeader
        title="Add a Vehicle"
        description="Enter the vehicle's details below."
      />

      <form id="add-vehicle-form" onSubmit={form.handleSubmit(onSubmit)}>
        <FormLayout>
          <FormSection
            title="The vehicle"
            description="Make, model and specification."
          >
          ...
          <FormSection
            title="Identity and papers"
            description="The plate, the VIN, and the dates that expire."
          >
            <div className="flex flex-col gap-5">
              <FormRow>
                <Controller
          ...
          <FormSection
            ...
            description="A new vehicle starts out available."
          >
            <FormRow>
              <Controller
                name="branchId"
