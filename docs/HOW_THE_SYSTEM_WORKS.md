# Motorpool Management System — How It Works

A complete, non-technical guide to what the system does and how each person uses it. No code, no setup — just what happens on screen and why.
...
*This document describes what the system does and who does it. It intentionally avoids technical setup and code — for running the app locally, see the project README.*
