...
const jobOrderSchema = z.object({
  ...
  repair_done: z.enum([...Object.values(REPAIR_DONE_TYPE), ''] as unknown as [string, ...string[]]).optional(),
  ...
  {
    message: 'Vehicle Date Accepted, Target Date, Assigned Mechanic, Repair Done, and Noted By are required when status is Assigned Mechanic',
    path: ['status']
  }
);
